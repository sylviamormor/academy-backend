...
class ApplicantService {
  ...
  static async loginApplicant(body) {
  ...
  static async setApplicantImageDb(email, imageUrl) {
  ...
  static async setApplicantDocDb(email, cvUrl) {
    const [applicantDoc = null] = await runQuery(
      applicantQuery.applicantDocumentSrc, [cvUrl, email]);
  ...
  static async setApplicantDetailsDb(body) {
    const {
